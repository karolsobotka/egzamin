...
namespace egzamin.Migrations
{
    ...
    [Migration("20230203093959_asd12321Migratio2222n")]
    partial class asd12321Migratio2222n
    {
            ...
            modelBuilder.Entity("egzamin.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdTeam = 1,
                            Deadline = new DateTime(2023, 2, 3, 10, 39, 59, 797, DateTimeKind.Local).AddTicks(7701),
                            MyProperty = 0,
                            Name = "projekt 1"
                        },
                        new
                        {
                            IdTeam = 2,
                            Deadline = new DateTime(2023, 2, 3, 10, 39, 59, 797, DateTimeKind.Local).AddTicks(7736),
                            MyProperty = 0,
                            Name = "projekt 2"
                        },
                        new
                        {
                            IdTeam = 3,
                            Deadline = new DateTime(2023, 2, 3, 10, 39, 59, 797, DateTimeKind.Local).AddTicks(7738),
                            MyProperty = 0,
                            Name = "projekt 3"
                        });
                });
